...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover jobs, required skills, and how to get there after graduation." },
      { name: "author", content: "PoliMiPathways" },
      { property: "og:title", content: "PoliMiPathways — Find your career path after university" },
      { property: "og:description", content: "Discover jobs, required skills, and how to get there after graduation." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@PoliMiPathways" },
      { name: "twitter:title", content: "PoliMiPathways — Find your career path after university" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300..800;1,9..40,300..800&display=swap" },
